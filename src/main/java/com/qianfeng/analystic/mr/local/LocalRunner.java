...
public class LocalRunner implements Tool{
    ...
    public int run(String[] args) throws Exception {
        ...
        TableMapReduceUtil.initTableMapperJob(this.getScans(job),LocalMapper.class,
                StatsLocalDimension.class, TextOutputValue.class,job,false);

        //reducer的设置
        job.setReducerClass(LocalReudcer.class);
    ...
    private List<Scan> getScans(Job job) {
        ...
        String[] fields = {
          ...
          EventLogsConstant.EVENT_COLUMN_NAME_SESSION_ID,
          EventLogsConstant.EVENT_COLUMN_NAME_PLATFORM,
          EventLogsConstant.EVENT_COLUMN_NAME_COUNTRY,
          EventLogsConstant.EVENT_COLUMN_NAME_PROVINCE,
          EventLogsConstant.EVENT_COLUMN_NAME_CITY
        };
        //将扫描的字段添加到filter中
